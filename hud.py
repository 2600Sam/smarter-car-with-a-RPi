...
def draw_hud():
	...
	pygame.draw.line(screen,red,(circle4_x,circle_y2),(secX),1)
	...
	pygame.draw.circle(screen, black, (int(circle5_x), int(circle_y2)), (int(time_radian)), 5)
...
while running:
	...
	screen.blit(loadDisplay, (circle3_x -((circle3_x / 8) - 55), circle_y + 60))
